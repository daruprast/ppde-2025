...
if __name__ == "__main__":
    ...
    menu_bar = tk.Menu(master=app)
    app.config(menu=menu_bar)
    # Membuat menu "File"
    file_menu = tk.Menu(master=menu_bar, tearoff=0)
    # Menambahkan item-item ke dalam menu "File"
    file_menu.add_command(label="Simpan Hasil", command=app.simpan_hasil)
    file_menu.add_separator() # Menambahkan garis pemisah
    file_menu.add_command(label="Keluar", command=app.keluar_aplikasi)
