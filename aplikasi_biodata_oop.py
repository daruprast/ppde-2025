# Nama  : Althaf Farras Ulayya Fauzo
# NIM   : 23106050090
...
class AplikasiBiodata(tk.Tk):
    ...
    def _buat_tampilan_login(self):
        self.frame_login = tk.Frame(self, padx=20, pady=100, bg="antiquewhite3")
        ...
        # Username
        tk.Label(self.frame_login, text="Username:", font=("Arial", 12), bg="antiquewhite3", fg="black").grid(row=1, column=0, sticky="W", pady=5)
        self.entry_username = tk.Entry(self.frame_login, font=("Arial", 12), bg="white", fg="black", highlightbackground="white")
        self.entry_username.grid(row=1, column=1, pady=5, sticky="EW")

        # Password + show/hide
        tk.Label(self.frame_login, text="Password:", font=("Arial", 12), bg="antiquewhite3", fg="black").grid(row=2, column=0, sticky="W", pady=5)
        frame_pass = tk.Frame(self.frame_login)
        frame_pass.grid(row=2, column=1, sticky="ew")
        frame_pass.grid_columnconfigure(0, weight=1)
        self.entry_password = tk.Entry(frame_pass, font=("Arial", 12), bg="white", fg="black", highlightbackground="white", show="*")
        self.entry_password.grid(row=0, column=0, sticky="ew")
        self.btn_toggle_pass = tk.Button(frame_pass, text="Show", command=self._toggle_password, bg="white", fg="black")
        self.btn_toggle_pass.grid(row=0, column=1, padx=5, sticky="ns")

        # Remember me
        self.var_remember = tk.IntVar()
        self.chk_remember = tk.Checkbutton(self.frame_login, text="Remember Me", variable=self.var_remember, bg="antiquewhite3", fg="black")
    ...
    def _buat_tampilan_biodata(self):
        ...
        self.frame_biodata = tk.Frame(self, padx=20, pady=20, bg="antiquewhite3")
        ...
        # Input nama
        tk.Label(self.frame_biodata, text="Nama Lengkap:", font=("Arial", 12), bg="antiquewhite3", fg="black").grid(row=1, column=0, sticky="w")
        self.entry_nama = tk.Entry(self.frame_biodata, textvariable=self.var_nama, font=("Arial", 12), bg="white", fg="black")
        self.entry_nama.grid(row=1, column=1, pady=5, sticky="ew")

        # Input NIM
        tk.Label(self.frame_biodata, text="NIM:", font=("Arial", 12), bg="antiquewhite3", fg="black").grid(row=2, column=0, sticky="w")
        self.entry_nim = tk.Entry(self.frame_biodata, textvariable=self.var_nim, font=("Arial", 12), bg="white", fg="black")
        self.entry_nim.grid(row=2, column=1, pady=5, sticky="ew")

        # Input jurusan
        tk.Label(self.frame_biodata, text="Jurusan:", font=("Arial", 12), bg="antiquewhite3", fg="black").grid(row=3, column=0, sticky="w")
        self.entry_jurusan = tk.Entry(self.frame_biodata, textvariable=self.var_jurusan, font=("Arial", 12), bg="white", fg="black")
        self.entry_jurusan.grid(row=3, column=1, pady=5, sticky="ew")

        # Input alamat
        tk.Label(self.frame_biodata, text="Alamat:", font=("Arial", 12), bg="antiquewhite3", fg="black").grid(row=4, column=0, sticky="nw")
        self.text_alamat = tk.Text(self.frame_biodata, height=5, width=30, font=("Arial", 12), bg="white", fg="black")
        self.text_alamat.grid(row=4, column=1, pady=5, sticky="ew")

        # Tambahan: Email
        tk.Label(self.frame_biodata, text="Email:", font=("Arial", 12), bg="antiquewhite3", fg="black").grid(row=5, column=0, sticky="w")
        self.entry_email = tk.Entry(self.frame_biodata, font=("Arial", 12), bg="white", fg="black")
        self.entry_email.grid(row=5, column=1, pady=5, sticky="ew")

        # Tambahan: Telepon
        tk.Label(self.frame_biodata, text="Telepon:", font=("Arial", 12), bg="antiquewhite3", fg="black").grid(row=6, column=0, sticky="w")
        self.entry_telepon = tk.Entry(self.frame_biodata, font=("Arial", 12), bg="white", fg="black")
        self.entry_telepon.grid(row=6, column=1, pady=5, sticky="ew")

        # Tambahan: Tanggal Lahir
        tk.Label(self.frame_biodata, text="Tanggal Lahir (DD-MM-YYYY):", font=("Arial", 12), bg="antiquewhite3", fg="black").grid(row=7, column=0, sticky="w")
        self.entry_tanggal = tk.Entry(self.frame_biodata, font=("Arial", 12), bg="white", fg="black")
        self.entry_tanggal.grid(row=7, column=1, pady=5, sticky="ew")

        # Jenis kelamin
        tk.Label(self.frame_biodata, text="Jenis Kelamin:", font=("Arial", 12), bg="antiquewhite3", fg="black").grid(row=8, column=0, sticky="w")
        frame_jk = tk.Frame(self.frame_biodata)
        frame_jk.grid(row=8, column=1, sticky="w")
        tk.Radiobutton(frame_jk, text="Pria", variable=self.var_jk, value="Pria", bg="antiquewhite3", fg="black").pack(side=tk.LEFT)
        tk.Radiobutton(frame_jk, text="Wanita", variable=self.var_jk, value="Wanita", bg="antiquewhite3", fg="black").pack(side=tk.LEFT)
        ...
        self.btn_reset = tk.Button(
            ...
            bg="antiquewhite3", fg="black",
            highlightthickness=2, highlightbackground="antiquewhite3",
        )
